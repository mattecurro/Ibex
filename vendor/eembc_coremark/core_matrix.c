...
/*	ee_printf("Matrix A:\n");
    for (i = 0; i < N; i++) {
        for (j = 0; j < N; j++) {
            ee_printf("%d\t", A[i * N + j]); // Assuming MATDAT is an integer type
        }
        ee_printf("\n");
	}
*/
...
/*/	ee_printf("Matrix C:\n");
    for (i = 0; i < N; i++) {
        for (j = 0; j < N; j++) {
            ee_printf("%d\t", C[i * N + j]); // Assuming MATDAT is an integer type
        }
        ee_printf("\n");
	}
	*/
...
/*	ee_printf("blksize %d\n", blksize);
    ...
    for (i = 0; i < N; i++) {
        for (j = 0; j < N; j++) {
            ee_printf("%d\t", B[i * N + j]); // Assuming MATDAT is an integer type
        }
        ee_printf("\n");
	}
*/
	ee_printf("Questa è la N: %d\n", N);
