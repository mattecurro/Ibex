...
enum opt_code
{
  ...
  OPT_mdiv = 1601,                           /* -mdiv */
  OPT_mexplicit_relocs = 1602,               /* -mexplicit-relocs */
  OPT_mfdiv = 1603,                          /* -mfdiv */
  OPT_mplt = 1604,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1605,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1606,                         /* -mrelax */
  OPT_mriscv_attribute = 1607,               /* -mriscv-attribute */
  OPT_msave_restore = 1608,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1609,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1610,                  /* -mstrict-align */
  OPT_mtune_ = 1611,                         /* -mtune= */
  OPT_n = 1612,                              /* -n */
  OPT_name_sort = 1613,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1614,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1615,              /* -no-integrated-cpp */
  OPT_no_pie = 1616,                         /* -no-pie */
  OPT_nocpp = 1617,                          /* -nocpp */
  OPT_nodefaultlibs = 1618,                  /* -nodefaultlibs */
  OPT_nolibc = 1619,                         /* -nolibc */
  OPT_nophoboslib = 1620,                    /* -nophoboslib */
  OPT_nostartfiles = 1621,                   /* -nostartfiles */
  OPT_nostdinc = 1622,                       /* -nostdinc */
  OPT_nostdinc__ = 1623,                     /* -nostdinc++ */
  OPT_nostdlib = 1624,                       /* -nostdlib */
  OPT_o = 1625,                              /* -o */
  OPT_objects = 1626,                        /* -objects */
  OPT_p = 1627,                              /* -p */
  OPT_pass_exit_codes = 1628,                /* -pass-exit-codes */
  /* OPT_pedantic = 1629, */                 /* -pedantic */
  OPT_pedantic_errors = 1630,                /* -pedantic-errors */
  OPT_pg = 1631,                             /* -pg */
  OPT_pie = 1632,                            /* -pie */
  OPT_pipe = 1633,                           /* -pipe */
  OPT_print_file_name_ = 1634,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1635,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1636,          /* -print-multi-directory */
  OPT_print_multi_lib = 1637,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1638,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1639,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1640,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1641,               /* -print-prog-name= */
  OPT_print_search_dirs = 1642,              /* -print-search-dirs */
  OPT_print_sysroot = 1643,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1644,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1645,                    /* -print-value */
  OPT_quiet = 1646,                          /* -quiet */
  OPT_r = 1647,                              /* -r */
  OPT_remap = 1648,                          /* -remap */
  OPT_reverse_sort = 1649,                   /* -reverse-sort */
  OPT_s = 1650,                              /* -s */
  OPT_save_temps = 1651,                     /* -save-temps */
  OPT_save_temps_ = 1652,                    /* -save-temps= */
  OPT_shared = 1653,                         /* -shared */
  OPT_shared_libgcc = 1654,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1655,               /* -shared-libphobos */
  OPT_size_sort = 1656,                      /* -size-sort */
  /* OPT_specs = 1657, */                    /* -specs */
  OPT_specs_ = 1658,                         /* -specs= */
  OPT_static = 1659,                         /* -static */
  OPT_static_libasan = 1660,                 /* -static-libasan */
  OPT_static_libgcc = 1661,                  /* -static-libgcc */
  OPT_static_libgfortran = 1662,             /* -static-libgfortran */
  OPT_static_libgo = 1663,                   /* -static-libgo */
  OPT_static_liblsan = 1664,                 /* -static-liblsan */
  OPT_static_libmpx = 1665,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1666,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1667,               /* -static-libphobos */
  OPT_static_libstdc__ = 1668,               /* -static-libstdc++ */
  OPT_static_libtsan = 1669,                 /* -static-libtsan */
  OPT_static_libubsan = 1670,                /* -static-libubsan */
  OPT_static_pie = 1671,                     /* -static-pie */
  /* OPT_std_c__03 = 1672, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1673, */                /* -std=c++0x */
  OPT_std_c__11 = 1674,                      /* -std=c++11 */
  OPT_std_c__14 = 1675,                      /* -std=c++14 */
  OPT_std_c__17 = 1676,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1677, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1678, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1679, */                /* -std=c++20 */
  OPT_std_c__2a = 1680,                      /* -std=c++2a */
  OPT_std_c__98 = 1681,                      /* -std=c++98 */
  OPT_std_c11 = 1682,                        /* -std=c11 */
  OPT_std_c17 = 1683,                        /* -std=c17 */
  /* OPT_std_c18 = 1684, */                  /* -std=c18 */
  /* OPT_std_c1x = 1685, */                  /* -std=c1x */
  OPT_std_c2x = 1686,                        /* -std=c2x */
  /* OPT_std_c89 = 1687, */                  /* -std=c89 */
  OPT_std_c90 = 1688,                        /* -std=c90 */
  OPT_std_c99 = 1689,                        /* -std=c99 */
  /* OPT_std_c9x = 1690, */                  /* -std=c9x */
  OPT_std_f2003 = 1691,                      /* -std=f2003 */
  OPT_std_f2008 = 1692,                      /* -std=f2008 */
  OPT_std_f2008ts = 1693,                    /* -std=f2008ts */
  OPT_std_f2018 = 1694,                      /* -std=f2018 */
  OPT_std_f95 = 1695,                        /* -std=f95 */
  OPT_std_gnu = 1696,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1697, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1698, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1699,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1700,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1701,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1702, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1703, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1704, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1705,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1706,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1707,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1708,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1709, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1710, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1711,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1712, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1713,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1714,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1715, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1716, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1717,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1718, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1719, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1720, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1721, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1722, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1723,                     /* -std=legacy */
  OPT_symbol_ = 1724,                        /* -symbol= */
  OPT_symbolic = 1725,                       /* -symbolic */
  OPT_t = 1726,                              /* -t */
  OPT_time = 1727,                           /* -time */
  OPT_time_ = 1728,                          /* -time= */
  OPT_traditional = 1729,                    /* -traditional */
  OPT_traditional_cpp = 1730,                /* -traditional-cpp */
  OPT_tree_stats = 1731,                     /* -tree-stats */
  OPT_trigraphs = 1732,                      /* -trigraphs */
  OPT_type_stats = 1733,                     /* -type-stats */
  OPT_u = 1734,                              /* -u */
  OPT_undef = 1735,                          /* -undef */
  OPT_v = 1736,                              /* -v */
  OPT_version = 1737,                        /* -version */
  OPT_w = 1738,                              /* -w */
  OPT_wrapper = 1739,                        /* -wrapper */
  OPT_x = 1740,                              /* -x */
  OPT_z = 1741,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
